...
-->
    ...
    <link rel="mask-icon" href="<?php bloginfo('url'); ?>/safari-pinned-tab.svg" color="#000000">
    ...
    fbq('init', '810282082441483');
    fbq('track', "PageView");
    </script>
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=810282082441483&ev=PageView&noscript=1" /></noscript>
    <!-- End Facebook Pixel Code -->

    <?php gravity_form_enqueue_scripts(3, true); wp_head(); ?>
</head>
<body <?php body_class(); ?>>
<!-- Google Tag Manager -->
<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-TG8BJ8"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=
'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-TG8BJ8');</script>
            ...
            <div class="container-inner clearfix">
                <h1 id="logo" class="pull-left">
                    <a href="<?php bloginfo('url'); ?>">
                        <img src="<?php bloginfo('url'); ?>/ui/svg/logo.svg" class="def-logo" width="220" height="66" alt="" />
                    </a>
                </h1>

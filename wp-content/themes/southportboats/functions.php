...
add_image_size( 'news-teaser-image', 520, 300, true);
...
function form_submit_button($button, $form){
    ...
    return "<button type='submit' class='submit btn black-btn' id='gform_submit_button_{" . $form["id"] . "}'><span>$button_text</span></button>";
}
